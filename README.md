...
The first option is prefert for sites not that not required globalisation. Due to the fact that ImageData is not localizable you have to go for the second solution if you have content in more then one language.
